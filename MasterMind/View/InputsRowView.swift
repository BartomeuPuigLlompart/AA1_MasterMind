    ...
    var body: some View {
        HStack{
            ...
            Button("OK", action: { viewModel.checkRow() })
                ...
                .font(.title2)
                .cornerRadius(30)
            Button("1", action: { viewModel.swapColor(_color: 1) })
                ...
                .font(.title2)
                .cornerRadius(30)
            Button("2", action: { viewModel.swapColor(_color: 2) })
                .frame(width: 20, height: 20, alignment: .center)
                .padding()
                ...
                .font(.title2)
                .cornerRadius(30)
            Button("3", action: { viewModel.swapColor(_color: 3) })
                .frame(width: 20, height: 20, alignment: .center)
                .padding()
                ...
                .font(.title2)
                .cornerRadius(30)
            Button("4", action: { viewModel.swapColor(_color: 4) })
                .frame(width: 20, height: 20, alignment: .center)
                .padding()
